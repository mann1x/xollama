...
if echo $PLATFORM | grep "," > /dev/null ; then
        tar c -C ./dist/linux_arm64 --exclude cuda_jetpack5 --exclude cuda_jetpack6 --exclude cuda_v12 . | zstd -9 -T0 >./dist/ollama-linux-arm64.tar.zst
        ( cd ./dist/linux_arm64 && tar c lib/ollama/cuda_v12 ) | zstd -9 -T0 >./dist/ollama-linux-arm64-cuda12.tar.zst
        ...
        tar c -C ./dist/linux_amd64 --exclude './lib/ollama/rocm*' --exclude './lib/ollama/mlx*' --exclude './lib/ollama/include' --exclude './lib/ollama/cuda_v12' . | zstd -9 -T0 >./dist/ollama-linux-amd64.tar.zst
        ( cd ./dist/linux_amd64 && tar c lib/ollama/cuda_v12 ) | zstd -9 -T0 >./dist/ollama-linux-amd64-cuda12.tar.zst
        ...
        tar c -C ./dist/ --exclude cuda_jetpack5 --exclude cuda_jetpack6 --exclude cuda_v12 bin lib | zstd -9 -T0 >./dist/ollama-linux-arm64.tar.zst
        ( cd ./dist/ && tar c lib/ollama/cuda_v12 ) | zstd -9 -T0 >./dist/ollama-linux-arm64-cuda12.tar.zst
        ...
        tar c -C ./dist/ --exclude 'lib/ollama/rocm*' --exclude 'lib/ollama/mlx*' --exclude 'lib/ollama/include' --exclude 'lib/ollama/cuda_v12' bin lib | zstd -9 -T0 >./dist/ollama-linux-amd64.tar.zst
        ( cd ./dist/ && tar c lib/ollama/cuda_v12 ) | zstd -9 -T0 >./dist/ollama-linux-amd64-cuda12.tar.zst
