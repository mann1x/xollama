...
|---|---|---|---|---|
| [Agentic Council Chat](agentic-council-chat.md) | ACTIVE | 6 built (live test on the next promoted build): PolyKV sizing, pressure and idle compaction, `num_ctx 0`, `slots.live`; 7 proposed: roles on other models and instances (5 of 5 closed 2026-09-26) | xollama | A model configured as a council (planner, researchers, critics, synthesizer) answers through the normal chat APIs, sharing KV through PolyKV |
